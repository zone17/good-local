...
> **Location in this repo:** the design system lives at `design/` (vendored from the
> Claude Design handoff, June 6, 2026). All paths below are relative to `design/`.
> The production app consumes it from `app/` — keep `design/` as the source of truth.
