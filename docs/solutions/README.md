...
| [propagated-claims-about-consumers.md](propagated-claims-about-consumers.md) | verification, vendored-code, review | A comment naming a consumer is a hypothesis; grep for the consumer before repeating it in a commit, PR, or ADR. |
