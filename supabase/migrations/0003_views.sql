...
create view gate_second_business_rate_21d as
with firsts as (
...
create view gate_same_business_repeat_rate as
with pairs as (
...
create view gate_median_checkins_per_active as
...
create view gate_steered_first_visit_rate as
...
create view gate_passport_adds as
...
create view gate_signups_per_business as
...
create view gate_paying_business_count as
...
create view gate_billing_retention_rate as
...
create view gate_metrics_all as
...
create view owner_visit_pattern_14d as
